  ...
  return (
    <main className="h-screen  bg-black dark:bg-white dark:text-black transition duration-300 ease-in-out">
      <div className="h-full max-w-7xl mx-auto p-5 flex flex-col items-center justify-center gap-10">
        ...
        <button className="text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-sky-500 cursor-pointer transition duration-300 ease-in-out hover:scale-110 hover:brightness-125" ><Link href="projetos">Meus Projetos</Link></button>
