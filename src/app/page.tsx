  ...
  return (
    <main className="h-screen  bg-black dark:bg-white dark:text-black transition duration-300 ease-in-out">
      <div className="h-full max-w-7xl mx-auto p-5 flex flex-col items-center justify-center gap-10">
        ...
        <button className="text-white text-base sm:text-lg md:text-xl w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-sky-500 cursor-pointer transition duration-300 ease-in-out hover:scale-110 hover:brightness-125" ><Link href="projects">Meus Projetos</Link></button>
        <a className="text-cyan-500 text-base sm:text-lg md:text-xl" href="https://drive.google.com/file/d/1WPz6hUwd6cCaZIr0a_42g33qSFl3E6f2/view?usp=sharing" target="_blank">Currículo...</a>
      </div>
    </main>
  )
}
