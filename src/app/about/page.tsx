const About = () => {
    return <div className="h-screen bg-black">
        <div className="max-w-7xl m-auto p-5 flex flex-col justify-center items-center bg-black text-white">
            ...
            <div className="flex mt-20 gap-10">
                <div className="w-[50%]">
                    <h2 className="mb-10 text-3xl">Conheça-me!</h2>
                ...
                <div><h2 className="mb-10 text-3xl">Minhas Habilidades</h2>
                <div>Icones Habilidades</div></div>
            </div>
        </div>
    </div>
  }
